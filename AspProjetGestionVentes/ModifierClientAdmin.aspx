<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifierClientAdmin.aspx.cs" Inherits="AspProjetGestionVentes.ModifierClientAdmin" %>
        ...
        <div style="background-color:#f8f8f8;" class="rounded p-2 container-sm-8 mb-3 mt-3 border border-secondary ">
            ...
            <div id="mainForm" class=" p-3">              
                ...
                <div class="row d-flex justify-content-around">
                    <asp:Button ID="btnModifier" class="btn btn-success col-sm-5" runat="server" Text="Modifier" OnClick="btnModifier_Click"  />
                </div>
                <!----------------------------------- START Alerts ---------------------------------------------->
                    <!--Alert Client Modifié-->
                <div style="display:none" id="alertVilleVide" runat="server" class="alert alert-success mt-3">
