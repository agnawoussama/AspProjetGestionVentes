...
{
    public partial class ModifierClientAdmin : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //Si Ontre sans login
            if (Session["numClientAdmin"] == null)
            {
            ...
            else
            {
                ...
                txtbxNumClient.Text = Session["numClientAdmin"].ToString();
                ...
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        ado.command.Parameters.AddWithValue("@numClient", Session["numClientAdmin"].ToString());
                        ado.Connecter();
                        ado.reader = ado.command.ExecuteReader();
                        if (ado.reader.HasRows)
                        {
